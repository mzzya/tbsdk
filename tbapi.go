...
func (req *TaobaoRegionPriceManageRequest) GetParams() map[string]interface{} {
    ...
    params["is_full"] = req.is_full
    
    params["item_id"] = req.item_id
    
    params["regional_price_dtos"] = req.regional_price_dtos
    
    params["sku_id"] = req.sku_id
...
func (req *TaobaoTmcQueueGetRequest) GetParams() map[string]interface{} {
    ...
    params["group_name"] = req.group_name
...
func (req *TaobaoWlbWmsReturnOrderNotifyRequest) GetParams() map[string]interface{} {
    ...
    params["buyer_nick"] = req.buyer_nick
    
    params["extend_fields"] = req.extend_fields
    
    params["order_code"] = req.order_code
    
    params["order_create_time"] = req.order_create_time
    
    params["order_flag"] = req.order_flag
    
    params["order_item_list"] = req.order_item_list
    
    params["order_source"] = req.order_source
    
    params["order_type"] = req.order_type
    
    params["owner_user_id"] = req.owner_user_id
    
    params["prev_order_code"] = req.prev_order_code
    
    params["receiver_info"] = req.receiver_info
    
    params["remark"] = req.remark
    
    params["return_reason"] = req.return_reason
    
    params["sender_info"] = req.sender_info
    
    params["store_code"] = req.store_code
    
    params["tms_order_code"] = req.tms_order_code
    
    params["tms_service_code"] = req.tms_service_code
    
    params["tms_service_name"] = req.tms_service_name
...
func (req *TaobaoJdsTradeTracesGetRequest) GetParams() map[string]interface{} {
    ...
    params["return_user_status"] = req.return_user_status
...
func (req *TaobaoWlbWmsSkuGetRequest) GetParams() map[string]interface{} {
    ...
    params["item_code"] = req.item_code
...
func (req *TaobaoLogisticsOrderCreateRequest) GetParams() map[string]interface{} {
    ...
    params["goods_names"] = req.goods_names
    
    params["goods_quantities"] = req.goods_quantities
    
    params["is_consign"] = req.is_consign
    
    params["item_values"] = req.item_values
    
    params["logis_company_code"] = req.logis_company_code
    
    params["logis_type"] = req.logis_type
    
    params["mail_no"] = req.mail_no
    
    params["order_type"] = req.order_type
    
    params["seller_wangwang_id"] = req.seller_wangwang_id
    
    params["shipping"] = req.shipping
    
    params["trade_id"] = req.trade_id
...
func (req *TaobaoItempropvaluesGetRequest) GetParams() map[string]interface{} {
    ...
    params["attr_keys"] = req.attr_keys
...
func (req *Gfq1qp4287ShopexAreaInfoGetRequest) GetParams() map[string]interface{} {
    ...
    params["qimen_body"] = req.qimen_body
...
func (req *TaobaoTmcMessagesConfirmRequest) GetParams() map[string]interface{} {
    ...
    params["f_message_ids"] = req.f_message_ids
    
    params["group_name"] = req.group_name
    
    params["s_message_ids"] = req.s_message_ids
...
func (req *TaobaoTmcMessageProduceRequest) GetParams() map[string]interface{} {
    ...
    params["ex_content"] = req.ex_content
    
    params["media_content"] = req.media_content
    
    params["media_content2"] = req.media_content2
    
    params["media_content3"] = req.media_content3
    
    params["media_content4"] = req.media_content4
    
    params["media_content5"] = req.media_content5
    
    params["target_appkey"] = req.target_appkey
...
func (req *TaobaoItemsOnsaleGetRequest) GetParams() map[string]interface{} {
    ...
    params["auction_type"] = req.auction_type
    
    params["cid"] = req.cid
    
    params["end_modified"] = req.end_modified
    
    params["fields"] = req.fields
    
    params["has_discount"] = req.has_discount
    
    params["has_showcase"] = req.has_showcase
    
    params["is_combine"] = req.is_combine
    
    params["is_cspu"] = req.is_cspu
    
    params["is_ex"] = req.is_ex
    
    params["is_taobao"] = req.is_taobao
    
    params["order_by"] = req.order_by
    
    params["page_no"] = req.page_no
    
    params["page_size"] = req.page_size
    
    params["q"] = req.q
    
    params["seller_cids"] = req.seller_cids
    
    params["start_modified"] = req.start_modified
...
func (req *CainiaoCrmOmsRuleSyncRequest) GetParams() map[string]interface{} {
    ...
    params["check_rule_msg"] = req.check_rule_msg
    
    params["is_auto_check"] = req.is_auto_check
    
    params["is_open_cnauto"] = req.is_open_cnauto
    
    params["is_sys_merge_order"] = req.is_sys_merge_order
    
    params["merge_order_cycle"] = req.merge_order_cycle
    
    params["other_rule"] = req.other_rule
    
    params["shop_code"] = req.shop_code
...
func (req *TaobaoItemUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["after_sale_id"] = req.after_sale_id
    
    params["approve_status"] = req.approve_status
    
    params["auction_point"] = req.auction_point
    
    params["auto_fill"] = req.auto_fill
    
    params["auto_repost"] = req.auto_repost
    
    params["barcode"] = req.barcode
    
    params["change_prop"] = req.change_prop
    
    params["chaoshi_extends_info"] = req.chaoshi_extends_info
    
    params["cid"] = req.cid
    
    params["cod_postage_id"] = req.cod_postage_id
    
    params["cpv_memo"] = req.cpv_memo
    
    params["delivery_time_delivery_time"] = req.delivery_time_delivery_time
    
    params["delivery_time_delivery_time_type"] = req.delivery_time_delivery_time_type
    
    params["delivery_time_need_delivery_time"] = req.delivery_time_need_delivery_time
    
    params["desc"] = req.desc
    
    params["desc_modules"] = req.desc_modules
    
    params["empty_fields"] = req.empty_fields
    
    params["ems_fee"] = req.ems_fee
    
    params["express_fee"] = req.express_fee
    
    params["features"] = req.features
    
    params["food_security_contact"] = req.food_security_contact
    
    params["food_security_design_code"] = req.food_security_design_code
    
    params["food_security_factory"] = req.food_security_factory
    
    params["food_security_factory_site"] = req.food_security_factory_site
    
    params["food_security_food_additive"] = req.food_security_food_additive
    
    params["food_security_health_product_no"] = req.food_security_health_product_no
    
    params["food_security_mix"] = req.food_security_mix
    
    params["food_security_period"] = req.food_security_period
    
    params["food_security_plan_storage"] = req.food_security_plan_storage
    
    params["food_security_prd_license_no"] = req.food_security_prd_license_no
    
    params["food_security_product_date_end"] = req.food_security_product_date_end
    
    params["food_security_product_date_start"] = req.food_security_product_date_start
    
    params["food_security_stock_date_end"] = req.food_security_stock_date_end
    
    params["food_security_stock_date_start"] = req.food_security_stock_date_start
    
    params["food_security_supplier"] = req.food_security_supplier
    
    params["freight_payer"] = req.freight_payer
    
    params["global_stock_country"] = req.global_stock_country
    
    params["global_stock_delivery_place"] = req.global_stock_delivery_place
    
    params["global_stock_tax_free_promise"] = req.global_stock_tax_free_promise
    
    params["global_stock_type"] = req.global_stock_type
    
    params["has_discount"] = req.has_discount
    
    params["has_invoice"] = req.has_invoice
    
    params["has_showcase"] = req.has_showcase
    
    params["has_warranty"] = req.has_warranty
    ...
    params["input_custom_cpv"] = req.input_custom_cpv
    
    params["input_pids"] = req.input_pids
    
    params["input_str"] = req.input_str
    
    params["interactive_id"] = req.interactive_id
    
    params["is_3D"] = req.is_3D
    
    params["is_ex"] = req.is_ex
    
    params["is_lightning_consignment"] = req.is_lightning_consignment
    
    params["is_offline"] = req.is_offline
    
    params["is_replace_sku"] = req.is_replace_sku
    
    params["is_taobao"] = req.is_taobao
    
    params["is_xinpin"] = req.is_xinpin
    
    params["item_size"] = req.item_size
    
    params["item_weight"] = req.item_weight
    
    params["lang"] = req.lang
    
    params["lease_extends_info"] = req.lease_extends_info
    
    params["list_time"] = req.list_time
    
    params["locality_life_choose_logis"] = req.locality_life_choose_logis
    
    params["locality_life_eticket"] = req.locality_life_eticket
    
    params["locality_life_expirydate"] = req.locality_life_expirydate
    
    params["locality_life_merchant"] = req.locality_life_merchant
    
    params["locality_life_network_id"] = req.locality_life_network_id
    
    params["locality_life_obs"] = req.locality_life_obs
    
    params["locality_life_onsale_auto_refund_ratio"] = req.locality_life_onsale_auto_refund_ratio
    
    params["locality_life_packageid"] = req.locality_life_packageid
    
    params["locality_life_refund_ratio"] = req.locality_life_refund_ratio
    
    params["locality_life_refundmafee"] = req.locality_life_refundmafee
    
    params["locality_life_verification"] = req.locality_life_verification
    
    params["locality_life_version"] = req.locality_life_version
    
    params["location_city"] = req.location_city
    
    params["location_state"] = req.location_state
    
    params["ms_payment_price"] = req.ms_payment_price
    
    params["ms_payment_reference_price"] = req.ms_payment_reference_price
    
    params["ms_payment_voucher_price"] = req.ms_payment_voucher_price
    
    params["newprepay"] = req.newprepay
    
    params["num"] = req.num
    
    params["num_iid"] = req.num_iid
    
    params["o2o_bind_service"] = req.o2o_bind_service
    
    params["outer_id"] = req.outer_id
    
    params["paimai_info_deposit"] = req.paimai_info_deposit
    
    params["paimai_info_interval"] = req.paimai_info_interval
    
    params["paimai_info_mode"] = req.paimai_info_mode
    
    params["paimai_info_reserve"] = req.paimai_info_reserve
    
    params["paimai_info_valid_hour"] = req.paimai_info_valid_hour
    
    params["paimai_info_valid_minute"] = req.paimai_info_valid_minute
    
    params["pic_path"] = req.pic_path
    
    params["post_fee"] = req.post_fee
    
    params["postage_id"] = req.postage_id
    
    params["price"] = req.price
    
    params["product_id"] = req.product_id
    
    params["property_alias"] = req.property_alias
    
    params["props"] = req.props
    
    params["qualification"] = req.qualification
    
    params["scenic_ticket_book_cost"] = req.scenic_ticket_book_cost
    
    params["scenic_ticket_pay_way"] = req.scenic_ticket_pay_way
    
    params["sell_point"] = req.sell_point
    
    params["sell_promise"] = req.sell_promise
    
    params["seller_cids"] = req.seller_cids
    
    params["shape"] = req.shape
    
    params["sku_barcode"] = req.sku_barcode
    
    params["sku_delivery_times"] = req.sku_delivery_times
    
    params["sku_hd_height"] = req.sku_hd_height
    
    params["sku_hd_lamp_quantity"] = req.sku_hd_lamp_quantity
    
    params["sku_hd_length"] = req.sku_hd_length
    
    params["sku_outer_ids"] = req.sku_outer_ids
    
    params["sku_prices"] = req.sku_prices
    
    params["sku_properties"] = req.sku_properties
    
    params["sku_quantities"] = req.sku_quantities
    
    params["sku_spec_ids"] = req.sku_spec_ids
    
    params["spu_confirm"] = req.spu_confirm
    
    params["stuff_status"] = req.stuff_status
    
    params["sub_stock"] = req.sub_stock
    
    params["title"] = req.title
    
    params["valid_thru"] = req.valid_thru
    
    params["video_id"] = req.video_id
    
    params["weight"] = req.weight
    
    params["wireless_desc"] = req.wireless_desc
...
func (req *TaobaoTmcUserCancelRequest) GetParams() map[string]interface{} {
    ...
    params["user_platform"] = req.user_platform
...
func (req *TaobaoNextoneLogisticsWarehouseUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["refund_id"] = req.refund_id
    
    params["warehouse_status"] = req.warehouse_status
...
func (req *TaobaoItemImgUploadRequest) GetParams() map[string]interface{} {
    ...
    params["is_major"] = req.is_major
    
    params["is_rectangle"] = req.is_rectangle
...
func (req *TmallChannelProductsGetRequest) GetParams() map[string]interface{} {
    ...
    params["top_query_product_d_o"] = req.top_query_product_d_o
...
func (req *TaobaoItemAddRequest) GetParams() map[string]interface{} {
    ...
    params["custom_made_type_id"] = req.custom_made_type_id
    ...
    params["support_custom_made"] = req.support_custom_made
...
func (req *TaobaoItemImgDeleteRequest) GetParams() map[string]interface{} {
    ...
    params["is_sixth_pic"] = req.is_sixth_pic
...
func (req *TaobaoItemSkuAddRequest) GetParams() map[string]interface{} {
    ...
    params["item_price"] = req.item_price
...
func (req *TaobaoRpRefundReviewRequest) GetParams() map[string]interface{} {
    ...
    params["refund_phase"] = req.refund_phase
    
    params["refund_version"] = req.refund_version
...
func (req *TaobaoWlbWaybillICancelRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_apply_cancel_request"] = req.waybill_apply_cancel_request
...
func (req *TaobaoWlbWaybillIQuerydetailRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_detail_query_request"] = req.waybill_detail_query_request
...
func (req *TaobaoWlbWaybillIPrintRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_apply_print_check_request"] = req.waybill_apply_print_check_request
...
func (req *TaobaoTradesSoldGetRequest) GetParams() map[string]interface{} {
    ...
    params["end_created"] = req.end_created
    
    params["ext_type"] = req.ext_type
    ...
    params["rate_status"] = req.rate_status
    
    params["start_created"] = req.start_created
    ...
    params["use_has_next"] = req.use_has_next
...
func (req *TaobaoTmcGroupsGetRequest) GetParams() map[string]interface{} {
    ...
    params["group_names"] = req.group_names
...
func (req *TaobaoRpReturngoodsRefuseRequest) GetParams() map[string]interface{} {
    ...
    params["refuse_proof"] = req.refuse_proof
    
    params["refuse_reason_id"] = req.refuse_reason_id
...
func (req *TaobaoRpReturngoodsRefillRequest) GetParams() map[string]interface{} {
    ...
    params["logistics_company_code"] = req.logistics_company_code
    
    params["logistics_waybill_no"] = req.logistics_waybill_no
...
func (req *TaobaoRefundsApplyGetRequest) GetParams() map[string]interface{} {
    ...
    params["seller_nick"] = req.seller_nick
...
func (req *TaobaoTraderatesGetRequest) GetParams() map[string]interface{} {
    ...
    params["peer_nick"] = req.peer_nick
...
func (req *AlibabaProviderEinvoiceQueryRequest) GetParams() map[string]interface{} {
    ...
    params["payee_register_no"] = req.payee_register_no
    
    params["platform_code"] = req.platform_code
    
    params["platform_tid"] = req.platform_tid
    
    params["serial_no"] = req.serial_no
...
func (req *CainiaoBmsOrderCreateRequest) GetParams() map[string]interface{} {
    ...
    params["buyer_message"] = req.buyer_message
    
    params["buyer_nick"] = req.buyer_nick
    
    params["cod_fee"] = req.cod_fee
    
    params["created"] = req.created
    
    params["discount_fee"] = req.discount_fee
    
    params["invoice_amount"] = req.invoice_amount
    
    params["invoice_title"] = req.invoice_title
    
    params["invoice_type"] = req.invoice_type
    
    params["is_cod"] = req.is_cod
    
    params["is_invoice"] = req.is_invoice
    
    params["items"] = req.items
    
    params["order_amount"] = req.order_amount
    
    params["order_type"] = req.order_type
    
    params["paied_amount"] = req.paied_amount
    
    params["pay_time"] = req.pay_time
    
    params["post_fee"] = req.post_fee
    
    params["receiver_address"] = req.receiver_address
    
    params["receiver_city"] = req.receiver_city
    
    params["receiver_country"] = req.receiver_country
    
    params["receiver_district"] = req.receiver_district
    
    params["receiver_mobile"] = req.receiver_mobile
    
    params["receiver_name"] = req.receiver_name
    
    params["receiver_phone"] = req.receiver_phone
    
    params["receiver_state"] = req.receiver_state
    
    params["receiver_town"] = req.receiver_town
    
    params["receiver_zip"] = req.receiver_zip
    
    params["seller_memo"] = req.seller_memo
    
    params["shop_code"] = req.shop_code
    
    params["trade_id"] = req.trade_id
    
    params["wait_pay_amount"] = req.wait_pay_amount
...
func (req *TaobaoFenxiaoProductSkuUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["agent_cost_price"] = req.agent_cost_price
    
    params["dealer_cost_price"] = req.dealer_cost_price
    ...
    params["sku_number"] = req.sku_number
    
    params["standard_price"] = req.standard_price
...
func (req *TaobaoWlbWaybillIProductRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_product_type_request"] = req.waybill_product_type_request
...
func (req *TaobaoJdsTradesStatisticsDiffRequest) GetParams() map[string]interface{} {
    ...
    params["post_status"] = req.post_status
    
    params["pre_status"] = req.pre_status
...
func (req *TaobaoJdsHluserUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["open_for_buyer"] = req.open_for_buyer
    
    params["open_nodes"] = req.open_nodes
...
func (req *TaobaoItemBarcodeUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["item_barcode"] = req.item_barcode
    
    params["item_id"] = req.item_id
    
    params["sku_barcodes"] = req.sku_barcodes
    
    params["sku_ids"] = req.sku_ids
...
func (req *TaobaoWlbWaybillIGetRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_apply_new_request"] = req.waybill_apply_new_request
...
func (req *TaobaoWlbWaybillISearchRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_apply_request"] = req.waybill_apply_request
...
func (req *TaobaoWlbWaybillIFullupdateRequest) GetParams() map[string]interface{} {
    ...
    params["waybill_apply_full_update_request"] = req.waybill_apply_full_update_request
...
func (req *TaobaoRegionSaleQueryRequest) GetParams() map[string]interface{} {
    ...
    params["sale_region_level"] = req.sale_region_level
...
func (req *TaobaoPictureIsreferencedGetRequest) GetParams() map[string]interface{} {
    ...
    params["picture_id"] = req.picture_id
...
func (req *TaobaoDeliveryTemplateUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["template_add_fees"] = req.template_add_fees
    
    params["template_add_standards"] = req.template_add_standards
    
    params["template_dests"] = req.template_dests
    
    params["template_id"] = req.template_id
    
    params["template_start_fees"] = req.template_start_fees
    
    params["template_start_standards"] = req.template_start_standards
    
    params["template_types"] = req.template_types
...
func (req *TaobaoDeliveryTemplateAddRequest) GetParams() map[string]interface{} {
    ...
    params["consign_area_id"] = req.consign_area_id
...
func (req *TaobaoOmniorderStoreSdtstatusRequest) GetParams() map[string]interface{} {
    ...
    params["package_id"] = req.package_id
...
func (req *TaobaoDeliveryTemplateGetRequest) GetParams() map[string]interface{} {
    ...
    params["template_ids"] = req.template_ids
    
    params["user_nick"] = req.user_nick
...
func (req *TaobaoQimenItemsMarkingRequest) GetParams() map[string]interface{} {
    ...
    params["action_type"] = req.action_type
    
    params["item_ids"] = req.item_ids
    
    params["remark"] = req.remark
    
    params["tag_type"] = req.tag_type
...
func (req *TaobaoPictureCategoryUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["category_name"] = req.category_name
...
func (req *TaobaoFenxiaoDealerRequisitionorderCreateRequest) GetParams() map[string]interface{} {
    ...
    params["buyer_name"] = req.buyer_name
    
    params["city"] = req.city
    
    params["district"] = req.district
    
    params["id_card_number"] = req.id_card_number
    
    params["logistics_type"] = req.logistics_type
    
    params["mobile"] = req.mobile
    
    params["order_detail"] = req.order_detail
    
    params["phone"] = req.phone
    
    params["post_code"] = req.post_code
...
func (req *TaobaoInventoryWarehouseManageRequest) GetParams() map[string]interface{} {
    ...
    params["ware_house_dto"] = req.ware_house_dto
...
func (req *TaobaoWlbOutInventoryChangeNotifyRequest) GetParams() map[string]interface{} {
    ...
    params["change_count"] = req.change_count
    
    params["item_id"] = req.item_id
    
    params["op_type"] = req.op_type
    
    params["order_source_code"] = req.order_source_code
    
    params["out_biz_code"] = req.out_biz_code
    
    params["result_count"] = req.result_count
...
func (req *TaobaoOmniorderStoreSwitchstatusGetRequest) GetParams() map[string]interface{} {
    ...
    params["seller_id"] = req.seller_id
...
func (req *CainiaoSmartdeliveryStrategyIUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["delivery_strategy_info"] = req.delivery_strategy_info
...
func (req *CainiaoSmartdeliveryPriceofferIQueryRequest) GetParams() map[string]interface{} {
    ...
    params["query_cp_price_info_request"] = req.query_cp_price_info_request
...
func (req *TaobaoOpenuidChangeRequest) GetParams() map[string]interface{} {
    ...
    params["open_uid"] = req.open_uid
    
    params["target_app_key"] = req.target_app_key
...
func (req *CainiaoSmartdeliveryPriceofferIUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["cp_price_info"] = req.cp_price_info
...
func (req *CainiaoSmartdeliveryCocpsIQueryRequest) GetParams() map[string]interface{} {
    ...
    params["send_address"] = req.send_address
...
func (req *TaobaoTraderateImprImprwordsGetRequest) GetParams() map[string]interface{} {
    ...
    params["cat_leaf_id"] = req.cat_leaf_id
    
    params["cat_root_id"] = req.cat_root_id
...
func (req *TaobaoItemcatsGetRequest) GetParams() map[string]interface{} {
    ...
    params["parent_cid"] = req.parent_cid
...
func (req *TaobaoItempropsGetRequest) GetParams() map[string]interface{} {
    ...
    params["child_path"] = req.child_path
    ...
    params["is_color_prop"] = req.is_color_prop
    
    params["is_enum_prop"] = req.is_enum_prop
    
    params["is_input_prop"] = req.is_input_prop
    
    params["is_item_prop"] = req.is_item_prop
    
    params["is_key_prop"] = req.is_key_prop
    
    params["is_sale_prop"] = req.is_sale_prop
    
    params["parent_pid"] = req.parent_pid
...
func (req *TaobaoTraderateImprImprwordByfeedidGetRequest) GetParams() map[string]interface{} {
    ...
    params["child_trade_id"] = req.child_trade_id
...
func (req *TaobaoPictureCategoryGetRequest) GetParams() map[string]interface{} {
    ...
    params["modified_time"] = req.modified_time
    
    params["parent_id"] = req.parent_id
    
    params["picture_category_id"] = req.picture_category_id
    
    params["picture_category_name"] = req.picture_category_name
...
func (req *TaobaoOmniorderStoreAccpetedRequest) GetParams() map[string]interface{} {
    ...
    params["report_timestamp"] = req.report_timestamp
    
    params["sub_order_list"] = req.sub_order_list
...
func (req *TaobaoPictureDeleteRequest) GetParams() map[string]interface{} {
    ...
    params["picture_ids"] = req.picture_ids
...
func (req *TaobaoPictureGetRequest) GetParams() map[string]interface{} {
    ...
    params["client_type"] = req.client_type
    
    params["deleted"] = req.deleted
    
    params["end_date"] = req.end_date
    
    params["is_https"] = req.is_https
...
func (req *TaobaoPictureUploadRequest) GetParams() map[string]interface{} {
    ...
    params["image_input_title"] = req.image_input_title
...
func (req *TaobaoMediaCategoryUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["media_category_id"] = req.media_category_id
    
    params["media_category_name"] = req.media_category_name
...
func (req *TaobaoFenxiaoRefundGetRequest) GetParams() map[string]interface{} {
    ...
    params["query_seller_refund"] = req.query_seller_refund
    
    params["sub_order_id"] = req.sub_order_id
...
func (req *TaobaoFenxiaoDistributorProductsGetRequest) GetParams() map[string]interface{} {
    ...
    params["download_status"] = req.download_status
    ...
    params["productcat_id"] = req.productcat_id
    
    params["start_time"] = req.start_time
    
    params["supplier_nick"] = req.supplier_nick
    
    params["time_type"] = req.time_type
    
    params["trade_type"] = req.trade_type
...
func (req *TaobaoWlbOrderJzpartnerQueryRequest) GetParams() map[string]interface{} {
    ...
    params["service_type"] = req.service_type
    
    params["taobao_trade_id"] = req.taobao_trade_id
...
func (req *TaobaoWlbOrderJzwithinsConsignRequest) GetParams() map[string]interface{} {
    ...
    params["ins_partner"] = req.ins_partner
    
    params["jz_consign_args"] = req.jz_consign_args
    
    params["tid"] = req.tid
    
    params["tms_partner"] = req.tms_partner
...
func (req *TaobaoSellercenterRoleAddRequest) GetParams() map[string]interface{} {
    ...
    params["permission_codes"] = req.permission_codes
...
func (req *CainiaoSmartdeliveryCpIModifyRequest) GetParams() map[string]interface{} {
    ...
    params["modify_smart_delivery_cp_request"] = req.modify_smart_delivery_cp_request
...
func (req *CainiaoSmartdeliveryIGetRequest) GetParams() map[string]interface{} {
    ...
    params["smart_delivery_batch_request"] = req.smart_delivery_batch_request
...
func (req *TaobaoFenxiaoOrdersGetRequest) GetParams() map[string]interface{} {
    ...
    params["purchase_order_id"] = req.purchase_order_id
    
    params["start_created"] = req.start_created
    
    params["status"] = req.status
    
    params["tc_order_id"] = req.tc_order_id
...
func (req *TaobaoWangwangAbstractLogqueryRequest) GetParams() map[string]interface{} {
    ...
    params["from_id"] = req.from_id
    
    params["next_key"] = req.next_key
    
    params["start_date"] = req.start_date
    
    params["to_id"] = req.to_id
...
func (req *TaobaoLogisticsOrderShengxianConfirmRequest) GetParams() map[string]interface{} {
    ...
    params["delivery_type"] = req.delivery_type
    
    params["logis_id"] = req.logis_id
    
    params["out_sid"] = req.out_sid
    
    params["seller_ip"] = req.seller_ip
    
    params["sender_id"] = req.sender_id
    
    params["service_code"] = req.service_code
...
func (req *TaobaoLogisticsConsignTcConfirmRequest) GetParams() map[string]interface{} {
    ...
    params["goods_list"] = req.goods_list
    
    params["out_trade_no"] = req.out_trade_no
    
    params["provider_id"] = req.provider_id
...
func (req *TaobaoLogisticsOrdersGetRequest) GetParams() map[string]interface{} {
    ...
    params["seller_confirm"] = req.seller_confirm
...
func (req *TaobaoLogisticsCompaniesGetRequest) GetParams() map[string]interface{} {
    ...
    params["is_recommended"] = req.is_recommended
    
    params["order_mode"] = req.order_mode
...
func (req *TmallItemQuantityUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["item_quantity"] = req.item_quantity
...
func (req *TaobaoTradeOrderskuUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["sku_props"] = req.sku_props
...
func (req *TaobaoInventoryInitialItemRequest) GetParams() map[string]interface{} {
    ...
    params["sc_item_id"] = req.sc_item_id
    
    params["store_inventorys"] = req.store_inventorys
...
func (req *TaobaoPicturePicturesCountRequest) GetParams() map[string]interface{} {
    ...
    params["start_modified_date"] = req.start_modified_date
...
func (req *TaobaoPicturePicturesGetRequest) GetParams() map[string]interface{} {
    ...
    params["current_page"] = req.current_page
...
func (req *TaobaoJushitaJdpUserAddRequest) GetParams() map[string]interface{} {
    ...
    params["history_days"] = req.history_days
    
    params["host_ip"] = req.host_ip
    
    params["host_name"] = req.host_name
    
    params["rds_name"] = req.rds_name
...
func (req *CainiaoCloudprintTemplatesMigrateRequest) GetParams() map[string]interface{} {
    ...
    params["custom_area_content"] = req.custom_area_content
    
    params["custom_area_name"] = req.custom_area_name
    
    params["tempalte_id"] = req.tempalte_id
...
func (req *TaobaoLogisticsPartnersGetRequest) GetParams() map[string]interface{} {
    ...
    params["goods_value"] = req.goods_value
    
    params["is_need_carriage"] = req.is_need_carriage
    
    params["service_type"] = req.service_type
    
    params["source_id"] = req.source_id
    
    params["target_id"] = req.target_id
...
func (req *TaobaoSubuserEmployeeAddRequest) GetParams() map[string]interface{} {
    ...
    params["department_id"] = req.department_id
    
    params["duty_id"] = req.duty_id
    
    params["employee_name"] = req.employee_name
    
    params["employee_nickname"] = req.employee_nickname
    
    params["employee_num"] = req.employee_num
    
    params["entry_date"] = req.entry_date
    
    params["id_card_num"] = req.id_card_num
    
    params["leader_id"] = req.leader_id
    
    params["office_phone"] = req.office_phone
    
    params["personal_email"] = req.personal_email
    
    params["personal_mobile"] = req.personal_mobile
    
    params["sex"] = req.sex
    
    params["sub_id"] = req.sub_id
    
    params["work_location"] = req.work_location
...
func (req *TaobaoSubuserInfoUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["is_disable_subaccount"] = req.is_disable_subaccount
    
    params["is_dispatch"] = req.is_dispatch
...
func (req *TaobaoUopTobOrderCreateRequest) GetParams() map[string]interface{} {
    ...
    params["delivery_order"] = req.delivery_order
...
func (req *TaobaoWlbWaybillShengxianGetRequest) GetParams() map[string]interface{} {
    ...
    params["biz_code"] = req.biz_code
    
    params["delivery_type"] = req.delivery_type
    
    params["feature"] = req.feature
    
    params["order_channels_type"] = req.order_channels_type
    
    params["sender_address_id"] = req.sender_address_id
...
func (req *CainiaoOpenstorageSellerResourceCreateRequest) GetParams() map[string]interface{} {
    ...
    params["param_create_seller_resource_request"] = req.param_create_seller_resource_request
...
func (req *CainiaoOpenstorageResourcePublishRequest) GetParams() map[string]interface{} {
    ...
    params["param_publish_resource_request"] = req.param_publish_resource_request
...
func (req *AlipayPointBudgetGetRequest) GetParams() map[string]interface{} {
    ...
    params["auth_token"] = req.auth_token
...
func (req *CainiaoOpenstorageResourceUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["param_update_resource_request"] = req.param_update_resource_request
...
func (req *CainiaoOpenstorageIsvResourcesGetRequest) GetParams() map[string]interface{} {
    ...
    params["isv_resource_type"] = req.isv_resource_type
...
func (req *AlipayPointOrderAddRequest) GetParams() map[string]interface{} {
    ...
    params["merchant_order_no"] = req.merchant_order_no
    
    params["order_time"] = req.order_time
    
    params["point_count"] = req.point_count
    
    params["user_symbol"] = req.user_symbol
    
    params["user_symbol_type"] = req.user_symbol_type
...
func (req *TaobaoFenxiaoProductUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["cost_price"] = req.cost_price
    
    params["dealer_cost_price"] = req.dealer_cost_price
    
    params["desc"] = req.desc
    
    params["discount_id"] = req.discount_id
    
    params["have_invoice"] = req.have_invoice
    
    params["have_quarantee"] = req.have_quarantee
    
    params["image"] = req.image
    
    params["input_properties"] = req.input_properties
    
    params["is_authz"] = req.is_authz
    ...
    params["postage_ems"] = req.postage_ems
    
    params["postage_fast"] = req.postage_fast
    
    params["postage_id"] = req.postage_id
    
    params["postage_ordinary"] = req.postage_ordinary
    
    params["postage_type"] = req.postage_type
    ...
    params["retail_price_high"] = req.retail_price_high
    
    params["retail_price_low"] = req.retail_price_low
    
    params["sku_cost_prices"] = req.sku_cost_prices
    
    params["sku_dealer_cost_prices"] = req.sku_dealer_cost_prices
    ...
    params["sku_properties_del"] = req.sku_properties_del
    
    params["sku_quantitys"] = req.sku_quantitys
    
    params["sku_standard_prices"] = req.sku_standard_prices
    
    params["standard_price"] = req.standard_price
    
    params["standard_retail_price"] = req.standard_retail_price
...
func (req *TaobaoTmcMsgSendrecordRequest) GetParams() map[string]interface{} {
    ...
    params["data_id"] = req.data_id
    
    params["group_name"] = req.group_name
    
    params["topic_name"] = req.topic_name
...
func (req *TaobaoFuwuSaleLinkGenRequest) GetParams() map[string]interface{} {
    ...
    params["param_str"] = req.param_str
...
func (req *CainiaoOpenstorageIsvResourceCreateRequest) GetParams() map[string]interface{} {
    ...
    params["param_create_isv_resource_request"] = req.param_create_isv_resource_request
...
func (req *TaobaoTopSecretGetRequest) GetParams() map[string]interface{} {
    ...
    params["customer_user_id"] = req.customer_user_id
    
    params["random_num"] = req.random_num
    
    params["secret_version"] = req.secret_version
...
func (req *TaobaoLogisticsAddressReachablebatchGetRequest) GetParams() map[string]interface{} {
    ...
    params["address_list"] = req.address_list
...
func (req *TaobaoOmniorderStoreReallocateRequest) GetParams() map[string]interface{} {
    ...
    params["main_order_id"] = req.main_order_id
    
    params["store_id"] = req.store_id
    
    params["sub_order_ids"] = req.sub_order_ids
    
    params["warehouse_code"] = req.warehouse_code
...
func (req *TaobaoFenxiaoOrderRemarkUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["supplier_memo"] = req.supplier_memo
    
    params["supplier_memo_flag"] = req.supplier_memo_flag
...
func (req *TaobaoInventoryAdjustExternalRequest) GetParams() map[string]interface{} {
    ...
    params["biz_type"] = req.biz_type
    
    params["biz_unique_code"] = req.biz_unique_code
    
    params["items"] = req.items
    
    params["occupy_operate_code"] = req.occupy_operate_code
    
    params["operate_time"] = req.operate_time
    
    params["operate_type"] = req.operate_type
    
    params["reduce_type"] = req.reduce_type
...
func (req *TaobaoInventoryQueryRequest) GetParams() map[string]interface{} {
    ...
    params["sc_item_codes"] = req.sc_item_codes
    
    params["sc_item_ids"] = req.sc_item_ids
    
    params["seller_nick"] = req.seller_nick
    
    params["store_codes"] = req.store_codes
...
func (req *TaobaoScitemMapAddRequest) GetParams() map[string]interface{} {
    ...
    params["need_check"] = req.need_check
    
    params["outer_code"] = req.outer_code
...
func (req *TaobaoInventoryAdjustTradeRequest) GetParams() map[string]interface{} {
    ...
    params["tb_order_type"] = req.tb_order_type
...
func (req *TaobaoFenxiaoProductcatUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["agent_cost_percent"] = req.agent_cost_percent
    
    params["dealer_cost_percent"] = req.dealer_cost_percent
    
    params["name"] = req.name
    
    params["product_line_id"] = req.product_line_id
    
    params["retail_high_percent"] = req.retail_high_percent
    
    params["retail_low_percent"] = req.retail_low_percent
...
func (req *TaobaoFenxiaoCooperationProductcatAddRequest) GetParams() map[string]interface{} {
    ...
    params["cooperate_id"] = req.cooperate_id
    
    params["grade_id"] = req.grade_id
    
    params["product_line_list"] = req.product_line_list
...
func (req *TmallItemSimpleschemaAddRequest) GetParams() map[string]interface{} {
    ...
    params["schema_xml_fields"] = req.schema_xml_fields
...
func (req *TaobaoFenxiaoCooperationAuditRequest) GetParams() map[string]interface{} {
    ...
    params["audit_result"] = req.audit_result
    
    params["product_line_list_agent"] = req.product_line_list_agent
    
    params["product_line_list_dealer"] = req.product_line_list_dealer
    
    params["remark"] = req.remark
    
    params["requisition_id"] = req.requisition_id
...
func (req *TaobaoFenxiaoRequisitionsGetRequest) GetParams() map[string]interface{} {
    ...
    params["apply_end"] = req.apply_end
    
    params["apply_start"] = req.apply_start
...
func (req *TaobaoLogisticsAddressReachableRequest) GetParams() map[string]interface{} {
    ...
    params["partner_ids"] = req.partner_ids
    
    params["service_type"] = req.service_type
    
    params["source_area_code"] = req.source_area_code
...
func (req *TaobaoFenxiaoCooperationTerminateRequest) GetParams() map[string]interface{} {
    ...
    params["end_remain_days"] = req.end_remain_days
    
    params["end_remark"] = req.end_remark
...
func (req *TaobaoQianniuKefuevalGetRequest) GetParams() map[string]interface{} {
    ...
    params["query_ids"] = req.query_ids
...
func (req *CainiaoSmartdeliveryStrategyWarehouseIQueryRequest) GetParams() map[string]interface{} {
    ...
    params["param_query_delivery_strategy_request"] = req.param_query_delivery_strategy_request
...
func (req *CainiaoSmartdeliveryStrategyWarehouseIUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["delivery_strategy_set_request"] = req.delivery_strategy_set_request
...
func (req *TaobaoFenxiaoProductImportFromAuctionRequest) GetParams() map[string]interface{} {
    ...
    params["auction_id"] = req.auction_id
...
func (req *TaobaoScitemQueryRequest) GetParams() map[string]interface{} {
    ...
    params["bar_code"] = req.bar_code
    
    params["item_name"] = req.item_name
    
    params["item_type"] = req.item_type
    
    params["outer_code"] = req.outer_code
    
    params["page_index"] = req.page_index
    
    params["page_size"] = req.page_size
    
    params["wms_code"] = req.wms_code
...
func (req *TaobaoScitemUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["brand_name"] = req.brand_name
    
    params["height"] = req.height
    
    params["is_area_sale"] = req.is_area_sale
    
    params["is_costly"] = req.is_costly
    
    params["is_dangerous"] = req.is_dangerous
    
    params["is_friable"] = req.is_friable
    
    params["is_warranty"] = req.is_warranty
    ...
    params["matter_status"] = req.matter_status
    ...
    params["remove_properties"] = req.remove_properties
    
    params["spu_id"] = req.spu_id
    
    params["update_properties"] = req.update_properties
...
func (req *AlipayUserAccountFreezeGetRequest) GetParams() map[string]interface{} {
    ...
    params["freeze_type"] = req.freeze_type
...
func (req *TaobaoFenxiaoProductMapAddRequest) GetParams() map[string]interface{} {
    ...
    params["not_check_outer_code"] = req.not_check_outer_code
...
func (req *AlipayUserTradeSearchRequest) GetParams() map[string]interface{} {
    ...
    params["alipay_order_no"] = req.alipay_order_no
    
    params["end_time"] = req.end_time
    
    params["merchant_order_no"] = req.merchant_order_no
    
    params["order_from"] = req.order_from
...
func (req *TmallItemShiptimeUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["ship_time"] = req.ship_time
    
    params["sku_ship_times"] = req.sku_ship_times
...
func (req *TmallInventoryQueryForstoreRequest) GetParams() map[string]interface{} {
    ...
    params["param_list"] = req.param_list
...
func (req *TaobaoWlbWmsSnInfoQueryRequest) GetParams() map[string]interface{} {
    ...
    params["order_code_type"] = req.order_code_type
...
func (req *CainiaoCloudprintCustomareaUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["custom_area_id"] = req.custom_area_id
...
func (req *TmallChannelProductsQueryRequest) GetParams() map[string]interface{} {
    ...
    params["product_number"] = req.product_number
...
func (req *CainiaoOpenstorageSellerResourcedetailGetRequest) GetParams() map[string]interface{} {
    ...
    params["seller_resource_id"] = req.seller_resource_id
...
func (req *CainiaoOpenstorageIsvResourcedetailGetRequest) GetParams() map[string]interface{} {
    ...
    params["isv_resource_id"] = req.isv_resource_id
...
func (req *TaobaoLogisticsTraceSearchRequest) GetParams() map[string]interface{} {
    ...
    params["is_split"] = req.is_split
    
    params["seller_nick"] = req.seller_nick
    
    params["sub_tid"] = req.sub_tid
...
func (req *CainiaoEndpointLockerTopStationAddorupdateRequest) GetParams() map[string]interface{} {
    ...
    params["station_info"] = req.station_info
...
func (req *AlibabaProviderEinvoiceCreateRequest) GetParams() map[string]interface{} {
    ...
    params["biz_sign"] = req.biz_sign
    
    params["business_type"] = req.business_type
    
    params["erp_tid"] = req.erp_tid
    
    params["invoice_amount"] = req.invoice_amount
    
    params["invoice_items"] = req.invoice_items
    
    params["invoice_memo"] = req.invoice_memo
    
    params["invoice_time"] = req.invoice_time
    
    params["invoice_type"] = req.invoice_type
    
    params["normal_invoice_code"] = req.normal_invoice_code
    
    params["normal_invoice_no"] = req.normal_invoice_no
    
    params["payee_address"] = req.payee_address
    
    params["payee_bankaccount"] = req.payee_bankaccount
    
    params["payee_checker"] = req.payee_checker
    
    params["payee_name"] = req.payee_name
    
    params["payee_operator"] = req.payee_operator
    
    params["payee_phone"] = req.payee_phone
    
    params["payee_receiver"] = req.payee_receiver
    
    params["payee_register_no"] = req.payee_register_no
    
    params["payer_address"] = req.payer_address
    
    params["payer_bankaccount"] = req.payer_bankaccount
    
    params["payer_email"] = req.payer_email
    
    params["payer_name"] = req.payer_name
    
    params["payer_phone"] = req.payer_phone
    
    params["payer_register_no"] = req.payer_register_no
    ...
    params["sum_price"] = req.sum_price
    
    params["sum_tax"] = req.sum_tax
...
func (req *TaobaoRpReturngoodsAgreeRequest) GetParams() map[string]interface{} {
    ...
    params["post_fee_bear_role"] = req.post_fee_bear_role
    ...
    params["seller_address_id"] = req.seller_address_id
...
func (req *TaobaoFenxiaoTrademonitorGetRequest) GetParams() map[string]interface{} {
    ...
    params["distributor_nick"] = req.distributor_nick
...
func (req *TaobaoRpRefundsAgreeRequest) GetParams() map[string]interface{} {
    ...
    params["refund_infos"] = req.refund_infos
...
func (req *TaobaoRefundRefuseRequest) GetParams() map[string]interface{} {
    ...
    params["refuse_message"] = req.refuse_message
...
func (req *TaobaoFenxiaoDealerRequisitionorderRemarkUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["dealer_order_id"] = req.dealer_order_id
...
func (req *TaobaoWlbWmsItemCombinationCreateRequest) GetParams() map[string]interface{} {
    ...
    params["sub_item_list"] = req.sub_item_list
...
func (req *TaobaoFenxiaoProductGradepriceUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["target_type"] = req.target_type
...
func (req *TaobaoRdcAligeniusOrderReturngoodsNotifyRequest) GetParams() map[string]interface{} {
    ...
    params["parent_order_id"] = req.parent_order_id
    
    params["refund_return_notes"] = req.refund_return_notes
...
func (req *TaobaoOmniorderStoreSdtquerystationRequest) GetParams() map[string]interface{} {
    ...
    params["param_long2"] = req.param_long2
...
func (req *TmallItemSizemappingTemplateCreateRequest) GetParams() map[string]interface{} {
    ...
    params["template_content"] = req.template_content
...
func (req *TaobaoOmniorderStoreGetconsignmailcodeRequest) GetParams() map[string]interface{} {
    ...
    params["sdt_extend_info_d_t_o"] = req.sdt_extend_info_d_t_o
    
    params["sender_contact"] = req.sender_contact
...
func (req *AlibabaEinvoiceCreatereqRequest) GetParams() map[string]interface{} {
    ...
    params["invoice_kind"] = req.invoice_kind
    ...
    params["out_shop_name"] = req.out_shop_name
    ...
    params["red_notice_no"] = req.red_notice_no
...
func (req *TaobaoTradesSoldIncrementvGetRequest) GetParams() map[string]interface{} {
    ...
    params["end_create"] = req.end_create
    ...
    params["start_create"] = req.start_create
...
func (req *TaobaoOmniorderStoreWarehouseRequest) GetParams() map[string]interface{} {
    ...
    params["warehouse_address"] = req.warehouse_address
    
    params["warehouse_code"] = req.warehouse_code
    
    params["warehouse_contact"] = req.warehouse_contact
    
    params["warehouse_mobile"] = req.warehouse_mobile
...
func (req *TmallStoredeliverAllocationAcceptRequest) GetParams() map[string]interface{} {
    ...
    params["allocation_code"] = req.allocation_code
    
    params["is_accept"] = req.is_accept
    
    params["sub_order_code"] = req.sub_order_code
...
func (req *TaobaoLogisticsExpressModifyAppointRequest) GetParams() map[string]interface{} {
    ...
    params["express_modify_appoint_top_request"] = req.express_modify_appoint_top_request
...
func (req *TaobaoLogisticsConsignResendRequest) GetParams() map[string]interface{} {
    ...
    params["company_code"] = req.company_code
...
func (req *TmallExchangeRefusereasonGetRequest) GetParams() map[string]interface{} {
    ...
    params["dispute_id"] = req.dispute_id
    
    params["dispute_type"] = req.dispute_type
...
func (req *TaobaoTaeBillsGetRequest) GetParams() map[string]interface{} {
    ...
    params["p_trade_id"] = req.p_trade_id
    
    params["page_size"] = req.page_size
    
    params["query_date_type"] = req.query_date_type
    
    params["query_end_date"] = req.query_end_date
    
    params["query_start_date"] = req.query_start_date
...
func (req *TaobaoOmniorderItemTagOperateRequest) GetParams() map[string]interface{} {
    ...
    params["omni_setting"] = req.omni_setting
...
func (req *TmallExchangeAgreeRequest) GetParams() map[string]interface{} {
    ...
    params["complete_address"] = req.complete_address
    
    params["dispute_id"] = req.dispute_id
    
    params["fields"] = req.fields
    
    params["leave_message"] = req.leave_message
    
    params["leave_message_pics"] = req.leave_message_pics
...
func (req *TmallExchangeRefuseRequest) GetParams() map[string]interface{} {
    ...
    params["seller_refuse_reason_id"] = req.seller_refuse_reason_id
...
func (req *TmallExchangeMessageAddRequest) GetParams() map[string]interface{} {
    ...
    params["message_pics"] = req.message_pics
...
func (req *TmallExchangeMessagesGetRequest) GetParams() map[string]interface{} {
    ...
    params["operator_roles"] = req.operator_roles
...
func (req *TmallExchangeConsigngoodsRequest) GetParams() map[string]interface{} {
    ...
    params["logistics_company_name"] = req.logistics_company_name
    
    params["logistics_no"] = req.logistics_no
...
func (req *TaobaoInventoryMerchantAdjustRequest) GetParams() map[string]interface{} {
    ...
    params["inventory_check"] = req.inventory_check
...
func (req *TaobaoWlbWmsSkuCreateRequest) GetParams() map[string]interface{} {
    ...
    params["advent_lifecycle"] = req.advent_lifecycle
    
    params["approval_number"] = req.approval_number
    ...
    params["gross_weight"] = req.gross_weight
    
    params["height"] = req.height
    
    params["is_area_sale"] = req.is_area_sale
    
    params["is_batch_mgt"] = req.is_batch_mgt
    
    params["is_danger"] = req.is_danger
    
    params["is_hygroscopic"] = req.is_hygroscopic
    
    params["is_shelflife"] = req.is_shelflife
    
    params["is_sn_mgt"] = req.is_sn_mgt
    ...
    params["lockup_lifecycle"] = req.lockup_lifecycle
    
    params["name"] = req.name
    
    params["net_weight"] = req.net_weight
    
    params["origin_address"] = req.origin_address
    
    params["pcs"] = req.pcs
    
    params["reject_lifecycle"] = req.reject_lifecycle
    ...
    params["tag_price"] = req.tag_price
    
    params["title"] = req.title
    
    params["_type"] = req._type
    
    params["use_yn"] = req.use_yn
...
func (req *TaobaoWlbWmsStockOutOrderNotifyRequest) GetParams() map[string]interface{} {
    ...
    params["car_no"] = req.car_no
    
    params["carriers_name"] = req.carriers_name
    ...
    params["outbound_type_desc"] = req.outbound_type_desc
    
    params["pick_call"] = req.pick_call
    
    params["pick_id"] = req.pick_id
    
    params["pick_name"] = req.pick_name
    ...
    params["send_time"] = req.send_time
    
    params["sender_info"] = req.sender_info
    
    params["store_code"] = req.store_code
    
    params["transport_mode"] = req.transport_mode
...
func (req *CainiaoWaybillIiGetRequest) GetParams() map[string]interface{} {
    ...
    params["param_waybill_cloud_print_apply_new_request"] = req.param_waybill_cloud_print_apply_new_request
...
func (req *TaobaoWlbWmsConsignOrderNotifyRequest) GetParams() map[string]interface{} {
    ...
    params["alipay_no"] = req.alipay_no
    
    params["ar_amount"] = req.ar_amount
    
    params["car_no"] = req.car_no
    
    params["carriers_name"] = req.carriers_name
    
    params["deliver_requirements"] = req.deliver_requirements
    
    params["discount_amount"] = req.discount_amount
    
    params["extend_fields"] = req.extend_fields
    
    params["got_amount"] = req.got_amount
    
    params["invoice_info_list"] = req.invoice_info_list
    ...
    params["order_examination_time"] = req.order_examination_time
    
    params["order_flag"] = req.order_flag
    
    params["order_item_list"] = req.order_item_list
    
    params["order_pay_time"] = req.order_pay_time
    
    params["order_priority"] = req.order_priority
    
    params["order_shop_create_time"] = req.order_shop_create_time
    
    params["order_source"] = req.order_source
    
    params["order_sub_source"] = req.order_sub_source
    
    params["order_type"] = req.order_type
    
    params["picker_call"] = req.picker_call
    
    params["picker_id"] = req.picker_id
    
    params["picker_name"] = req.picker_name
    ...
    params["service_fee"] = req.service_fee
...
func (req *CainiaoWaybillIiUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["param_waybill_cloud_print_update_request"] = req.param_waybill_cloud_print_update_request
...
func (req *CainiaoEndpointLockerTopOrderTrackingNewRequest) GetParams() map[string]interface{} {
    ...
    params["track_info"] = req.track_info
...
func (req *CainiaoEndpointLockerTopOrderNoticeRequest) GetParams() map[string]interface{} {
    ...
    params["scene_code"] = req.scene_code
    
    params["station_id"] = req.station_id
...
func (req *CainiaoEndpointLockerTopOrderNoticesendQueryRequest) GetParams() map[string]interface{} {
    ...
    params["getter_phone"] = req.getter_phone
...
func (req *TmallExchangeReceiveGetRequest) GetParams() map[string]interface{} {
    ...
    params["biz_order_id"] = req.biz_order_id
    
    params["buyer_id"] = req.buyer_id
    
    params["buyer_nick"] = req.buyer_nick
    
    params["dispute_status_array"] = req.dispute_status_array
    
    params["end_created_time"] = req.end_created_time
    
    params["end_gmt_modifed_time"] = req.end_gmt_modifed_time
    
    params["fields"] = req.fields
    
    params["logistic_no"] = req.logistic_no
    
    params["page_no"] = req.page_no
    
    params["page_size"] = req.page_size
    
    params["refund_id_array"] = req.refund_id_array
    
    params["start_created_time"] = req.start_created_time
    
    params["start_gmt_modified_time"] = req.start_gmt_modified_time
...
func (req *TaobaoLocationRelationQueryRequest) GetParams() map[string]interface{} {
    ...
    params["location_relation"] = req.location_relation
...
func (req *TaobaoLocationRelationEditRequest) GetParams() map[string]interface{} {
    ...
    params["location_relation_list"] = req.location_relation_list
...
func (req *TaobaoWlbWmsReturnBillGetRequest) GetParams() map[string]interface{} {
    ...
    params["cn_order_code"] = req.cn_order_code
...
func (req *TaobaoOcTradetagAttachRequest) GetParams() map[string]interface{} {
    ...
    params["tag_value"] = req.tag_value
...
func (req *TaobaoOcTradetagsGetRequest) GetParams() map[string]interface{} {
    ...
    params["tag_names"] = req.tag_names
    
    params["tag_types"] = req.tag_types
...
func (req *QimenTaobaoCrmOrderSyncRequest) GetParams() map[string]interface{} {
    ...
    params["data_type"] = req.data_type
    
    params["from_node_id"] = req.from_node_id
    
    params["from_type"] = req.from_type
    
    params["msg_id"] = req.msg_id
...
func (req *CainiaoMerchantInventoryAdjustRequest) GetParams() map[string]interface{} {
    ...
    params["adjust_request"] = req.adjust_request
...
func (req *TaobaoWlbWmsCainiaoBillQueryRequest) GetParams() map[string]interface{} {
    ...
    params["end_modified_time"] = req.end_modified_time
    ...
    params["start_modified_time"] = req.start_modified_time
...
func (req *CainiaoWaybillIiCancelRequest) GetParams() map[string]interface{} {
    ...
    params["cp_code"] = req.cp_code
    
    params["waybill_code"] = req.waybill_code
...
func (req *TaobaoWlbWmsStockInOrderNotifyRequest) GetParams() map[string]interface{} {
    ...
    params["expect_end_time"] = req.expect_end_time
    
    params["expect_start_time"] = req.expect_start_time
    
    params["extend_fields"] = req.extend_fields
    
    params["inbound_type_desc"] = req.inbound_type_desc
    ...
    params["supplier_code"] = req.supplier_code
    
    params["supplier_name"] = req.supplier_name
...
func (req *AlipaySystemOauthTokenRequest) GetParams() map[string]interface{} {
    ...
    params["grant_type"] = req.grant_type
...
func (req *TaobaoOmniorderStoreDeliverconfigUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["store_deliver_config"] = req.store_deliver_config
...
func (req *TaobaoOmniorderStoreCollectconfigUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["store_collect_config"] = req.store_collect_config
...
func (req *TaobaoWlbWmsInventoryQueryRequest) GetParams() map[string]interface{} {
    ...
    params["batch_code"] = req.batch_code
    
    params["channel_code"] = req.channel_code
    
    params["due_date"] = req.due_date
    
    params["inventory_type"] = req.inventory_type
    ...
    params["produce_date"] = req.produce_date
...
func (req *AlibabaEinvoicePaperPrintRequest) GetParams() map[string]interface{} {
    ...
    params["dialog_setting_flag"] = req.dialog_setting_flag
    
    params["force_print"] = req.force_print
    
    params["payee_register_no"] = req.payee_register_no
    
    params["print_flag"] = req.print_flag
...
func (req *AlibabaEinvoicePaperInvalidRequest) GetParams() map[string]interface{} {
    ...
    params["invalid_operator"] = req.invalid_operator
    
    params["invalid_type"] = req.invalid_type
    
    params["invoice_code"] = req.invoice_code
    
    params["invoice_no"] = req.invoice_no
...
func (req *TaobaoTaeBookBillsGetRequest) GetParams() map[string]interface{} {
    ...
    params["journal_types"] = req.journal_types
...
func (req *TaobaoWlbOrderJzQueryRequest) GetParams() map[string]interface{} {
    ...
    params["ins_jz_receiver_t_o"] = req.ins_jz_receiver_t_o
    
    params["jz_receiver_to"] = req.jz_receiver_to
...
func (req *TaobaoFenxiaoDistributorItemsGetRequest) GetParams() map[string]interface{} {
    ...
    params["distributor_id"] = req.distributor_id
...
func (req *TaobaoFenxiaoOrderConfirmPaidRequest) GetParams() map[string]interface{} {
    ...
    params["confirm_remark"] = req.confirm_remark
...
func (req *TaobaoQianniuCloudkefuStatuslogGetRequest) GetParams() map[string]interface{} {
    ...
    params["account_ids"] = req.account_ids
    
    params["domian"] = req.domian
    
    params["end_time"] = req.end_time
    
    params["main_account_id"] = req.main_account_id
...
func (req *TaobaoWlbOrderJzConsignRequest) GetParams() map[string]interface{} {
    ...
    params["ins_receiver_to"] = req.ins_receiver_to
    
    params["ins_tp_dto"] = req.ins_tp_dto
    
    params["jz_receiver_to"] = req.jz_receiver_to
    
    params["jz_top_args"] = req.jz_top_args
    
    params["lg_tp_dto"] = req.lg_tp_dto
...
func (req *TaobaoWlbImportThreeplResourceGetRequest) GetParams() map[string]interface{} {
    ...
    params["to_address"] = req.to_address
...
func (req *TaobaoWlbImportThreeplOfflineConsignRequest) GetParams() map[string]interface{} {
    ...
    params["res_code"] = req.res_code
    
    params["res_id"] = req.res_id
    
    params["trade_id"] = req.trade_id
    
    params["waybill_no"] = req.waybill_no
...
func (req *TmallItemOuteridUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["sku_outers"] = req.sku_outers
...
func (req *TaobaoSkusQuantityUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["outerid_quantities"] = req.outerid_quantities
    
    params["skuid_quantities"] = req.skuid_quantities
...
func (req *CainiaoEndpointLockerTopWithholdQueryRequest) GetParams() map[string]interface{} {
    ...
    params["open_user_id"] = req.open_user_id
...
func (req *TaobaoWangwangEserviceChatrelationGetRequest) GetParams() map[string]interface{} {
    ...
    params["chat_relation_request"] = req.chat_relation_request
...
func (req *CainiaoEndpointLockerTopOrderWithholdRequest) GetParams() map[string]interface{} {
    ...
    params["total_fee"] = req.total_fee
...
func (req *TaobaoWlbItemAddRequest) GetParams() map[string]interface{} {
    ...
    params["goods_cat"] = req.goods_cat
    ...
    params["package_material"] = req.package_material
    
    params["price"] = req.price
    
    params["pricing_cat"] = req.pricing_cat
    
    params["pro_name_list"] = req.pro_name_list
    
    params["pro_value_list"] = req.pro_value_list
    
    params["remark"] = req.remark
    
    params["support_batch"] = req.support_batch
...
func (req *TaobaoWlbWlborderGetRequest) GetParams() map[string]interface{} {
    ...
    params["wlb_order_code"] = req.wlb_order_code
...
func (req *CainiaoNbaddAppointdeliverGetconsigninfoRequest) GetParams() map[string]interface{} {
    ...
    params["trade_order_id"] = req.trade_order_id
...
func (req *TaobaoOmniorderDtdConsumeRequest) GetParams() map[string]interface{} {
    ...
    params["param_door2door_consume_request"] = req.param_door2door_consume_request
...
func (req *TaobaoWlbInventoryDetailGetRequest) GetParams() map[string]interface{} {
    ...
    params["inventory_type_list"] = req.inventory_type_list
...
func (req *TaobaoWlbTradeorderGetRequest) GetParams() map[string]interface{} {
    ...
    params["sub_trade_id"] = req.sub_trade_id
...
func (req *TaobaoWlbOrderCreateRequest) GetParams() map[string]interface{} {
    ...
    params["invoince_info"] = req.invoince_info
    
    params["is_finished"] = req.is_finished
    ...
    params["order_sub_type"] = req.order_sub_type
    
    params["order_type"] = req.order_type
    
    params["out_biz_code"] = req.out_biz_code
    
    params["package_count"] = req.package_count
    
    params["payable_amount"] = req.payable_amount
    ...
    params["schedule_end"] = req.schedule_end
    
    params["schedule_start"] = req.schedule_start
    
    params["schedule_type"] = req.schedule_type
    ...
    params["tms_info"] = req.tms_info
    
    params["tms_order_code"] = req.tms_order_code
    
    params["tms_service_code"] = req.tms_service_code
    
    params["total_amount"] = req.total_amount
...
func (req *TaobaoLogisticsConsignOrderCreateandsendRequest) GetParams() map[string]interface{} {
    ...
    params["item_json_string"] = req.item_json_string
    ...
    params["r_address"] = req.r_address
    
    params["r_area_id"] = req.r_area_id
    
    params["r_city_name"] = req.r_city_name
    
    params["r_dist_name"] = req.r_dist_name
    
    params["r_mobile_phone"] = req.r_mobile_phone
    
    params["r_name"] = req.r_name
    
    params["r_prov_name"] = req.r_prov_name
    
    params["r_telephone"] = req.r_telephone
    
    params["r_zip_code"] = req.r_zip_code
    
    params["s_address"] = req.s_address
    
    params["s_area_id"] = req.s_area_id
    
    params["s_city_name"] = req.s_city_name
    
    params["s_dist_name"] = req.s_dist_name
    
    params["s_mobile_phone"] = req.s_mobile_phone
    
    params["s_name"] = req.s_name
    
    params["s_prov_name"] = req.s_prov_name
    
    params["s_telephone"] = req.s_telephone
    
    params["s_zip_code"] = req.s_zip_code
...
func (req *TaobaoInventoryIpcInventorydetailGetRequest) GetParams() map[string]interface{} {
    ...
    params["biz_sub_order_id"] = req.biz_sub_order_id
    ...
    params["status_query"] = req.status_query
...
func (req *TaobaoLogisticsAddressAddRequest) GetParams() map[string]interface{} {
    ...
    params["cancel_def"] = req.cancel_def
    
    params["city"] = req.city
    
    params["contact_name"] = req.contact_name
    
    params["country"] = req.country
    
    params["get_def"] = req.get_def
    
    params["memo"] = req.memo
    
    params["mobile_phone"] = req.mobile_phone
    
    params["phone"] = req.phone
    
    params["province"] = req.province
    
    params["seller_company"] = req.seller_company
    
    params["send_def"] = req.send_def
    
    params["zip_code"] = req.zip_code
...
func (req *TaobaoLogisticsAddressRemoveRequest) GetParams() map[string]interface{} {
    ...
    params["contact_id"] = req.contact_id
...
func (req *TaobaoFenxiaoDiscountsGetRequest) GetParams() map[string]interface{} {
    ...
    params["ext_fields"] = req.ext_fields
...
func (req *QimenTaobaoAlphaxOpenJxtInvoiceRequest) GetParams() map[string]interface{} {
    ...
    params["company_title"] = req.company_title
    
    params["extend_arg"] = req.extend_arg
    
    params["invoice_attr"] = req.invoice_attr
...
func (req *TaobaoVasSubscSearchRequest) GetParams() map[string]interface{} {
    ...
    params["article_code"] = req.article_code
    
    params["autosub"] = req.autosub
    
    params["end_deadline"] = req.end_deadline
    
    params["expire_notice"] = req.expire_notice
    ...
    params["start_deadline"] = req.start_deadline
...
func (req *CainiaoCloudprintClientinfoPutRequest) GetParams() map[string]interface{} {
    ...
    params["json_data"] = req.json_data
...
func (req *TaobaoWlbItemMapGetByExtentityRequest) GetParams() map[string]interface{} {
    ...
    params["ext_entity_id"] = req.ext_entity_id
    
    params["ext_entity_type"] = req.ext_entity_type
...
func (req *TaobaoItemIncrementUpdateSchemaGetRequest) GetParams() map[string]interface{} {
    ...
    params["update_fields"] = req.update_fields
...
func (req *TaobaoWlbItemUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["delete_property_key_list"] = req.delete_property_key_list
    ...
    params["update_property_key_list"] = req.update_property_key_list
    
    params["update_property_value_list"] = req.update_property_value_list
...
func (req *TaobaoWlbInventorylogQueryRequest) GetParams() map[string]interface{} {
    ...
    params["gmt_end"] = req.gmt_end
    
    params["gmt_start"] = req.gmt_start
    
    params["item_id"] = req.item_id
    
    params["op_type"] = req.op_type
    
    params["op_user_id"] = req.op_user_id
...
func (req *TaobaoTopatsJushitaJdpDatadeleteRequest) GetParams() map[string]interface{} {
    ...
    params["sync_types"] = req.sync_types
...
func (req *TaobaoFenxiaoDealerRequisitionorderCloseRequest) GetParams() map[string]interface{} {
    ...
    params["reason_detail"] = req.reason_detail
...
func (req *TaobaoQimenOrderstatusUpdateRequest) GetParams() map[string]interface{} {
    ...
    params["action_time"] = req.action_time
    
    params["allocation_code"] = req.allocation_code
    
    params["operator"] = req.operator
    
    params["order_codes"] = req.order_codes
...
func (req *TaobaoFenxiaoDealerRequisitionorderQueryRequest) GetParams() map[string]interface{} {
    ...
    params["dealer_order_ids"] = req.dealer_order_ids
...
func (req *TaobaoFenxiaoTradePrepayOfflineReduceRequest) GetParams() map[string]interface{} {
    ...
    params["offline_reduce_prepay_param"] = req.offline_reduce_prepay_param
...
func (req *TaobaoFenxiaoTradePrepayOfflineAddRequest) GetParams() map[string]interface{} {
    ...
    params["offline_add_prepay_param"] = req.offline_add_prepay_param
